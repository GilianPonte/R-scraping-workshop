...
# Exercise 3: We want to scrape the prices of Amazon.de instead of Bol.com. 
# Make a copy of the loop and try to replace the search url and css selectors in the code. 
# The result should be a dataframe with only the EAN and price.
